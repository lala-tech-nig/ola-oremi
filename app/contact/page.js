    ...
    <div className="min-h-screen bg-[#F8F9FB] font-sans text-[#4A5568]">
      ...
      <nav className="flex items-center justify-between px-8 md:px-20 py-4 bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="bg-[#0052CC] p-1.5 rounded text-white">
            <Settings size={18} />
          </div>
          <span className="font-bold text-lg text-[#003366] tracking-tight uppercase">OLA-OREMI LTD</span>
        </div>
        <div className="hidden md:flex gap-10 text-[12px] font-bold text-gray-500 uppercase tracking-[0.15em]">
          <a href="/" className="hover:text-[#0052CC] transition">Home</a>
          <a href="/about" className="hover:text-[#0052CC] transition">About Us</a>
          <a href="/services" className="hover:text-[#0052CC] transition">Services</a>
          <a href="/projects" className="hover:text-[#0052CC] transition">Projects</a>
          <a href="/contact" className="text-[#0052CC]">Contact</a>
        </div>
        <button className="bg-[#0052CC] text-white px-6 py-2.5 rounded font-bold text-sm shadow-lg shadow-blue-100 hover:bg-blue-700 transition">
          Get Quote
        </button>
      </nav>
      ...
      <section className="relative h-[400px] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-6">
          ...
          <p className="text-blue-100 text-lg font-light max-w-2xl mx-auto leading-relaxed">
            Reach out to our engineering team for consultations, project quotes, or general inquiries. We are ready to build your vision.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-8 md:px-20 py-24 grid lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-5">
          ...
          <p className="text-gray-500 text-sm mb-12 leading-relaxed">
            Visit our head office in Ogun State or reach out directly via phone or email for immediate assistance.
          </p>
          ...
          <div className="space-y-6 mb-12">
            ...
            <ContactMethodCard 
              ...
              value="info@olaoremi.ng"
              action="SEND EMAIL"
            />
          </div>

          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            <h4 className="flex items-center gap-2 font-bold text-[#002B5B] mb-6 text-sm uppercase tracking-widest">
              <Clock size={16} className="text-blue-600" /> Operating Hours
            </h4>
            <div className="space-y-3 text-sm font-medium">
              <div className="flex justify-between border-b border-gray-50 pb-2">
                <span className="text-gray-400">Monday - Friday</span>
                <span className="text-[#002B5B]">8:00 AM - 6:00 PM</span>
              </div>
              <div className="flex justify-between border-b border-gray-50 pb-2">
                <span className="text-gray-400">Saturday</span>
                <span className="text-[#002B5B]">9:00 AM - 4:00 PM</span>
              </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-[#F8FAFC] border border-gray-100 rounded-xl px-5 py-4 text-sm outline-none focus:border-blue-500 transition resize-none"
                ></textarea>
              </div>
              <button className="w-full bg-[#0052CC] text-white py-5 rounded-xl font-bold text-base flex items-center justify-center gap-3 hover:bg-blue-700 transition shadow-lg shadow-blue-100">
      ...
      <section className="px-8 md:px-20 pb-24">
        ...
        <div className="relative w-full h-[500px] rounded-[40px] overflow-hidden bg-[#0A4A4A] border-8 border-white shadow-2xl">
          {/* Conceptual Map Image from source */}
          <img 
            src="https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?q=80&w=2070" 
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative flex flex-col items-center">
              ...
              <div className="mt-4 bg-white px-4 py-2 rounded-lg shadow-xl text-[10px] font-bold text-[#002B5B] uppercase tracking-widest border border-gray-100">
                Ola-Oremi HQ
              </div>
            </div>
          </div>
          <div className="absolute bottom-6 right-8">
            <a href="#" className="bg-white/90 backdrop-blur-md px-6 py-3 rounded-full text-xs font-bold text-blue-600 flex items-center gap-2 hover:bg-white transition shadow-lg">
      ...
      {/* --- Footer --- */}
      <footer className="bg-[#0A1D37] text-white px-8 md:px-20 pt-24 pb-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-8">
              <span className="font-bold text-xl tracking-tighter">OLA-OREMI LTD</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-8">
              Delivering excellence in construction and property development across Nigeria. We build with integrity, precision, and passion.
            </p>
          ...
          <FooterNav title="Quick Links" links={['About Us', 'Our Services', 'Projects Gallery', 'Get a Quote']} />
          <FooterNav title="Contact" links={['0703 333 2733', 'info@olaoremi.ng', '27, Ijoko Road, Nigeria']} />
        </div>
        <div className="pt-12 border-t border-white/5 text-center">
          <p className="text-[10px] text-gray-500 uppercase tracking-[0.3em]">
            © 2023 Ola-Oremi Nigeria Limited. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
...
function ContactMethodCard({ icon, title, value, action }) {
  return (
    <div className="bg-white p-6 rounded-2xl border border-gray-50 flex items-center gap-6 group hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300">
      ...
      <div className="flex-1">
        ...
        {action && (
          <button className="text-[10px] font-extrabold text-blue-600 mt-2 tracking-widest hover:underline">
            {action}
          </button>
        )}
      </div>
  ...
  return (
    <div>
      ...
      <input 
        ...
        className="w-full bg-[#F8FAFC] border border-gray-100 rounded-xl px-5 py-4 text-sm outline-none focus:border-blue-500 transition"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <ul className="space-y-4">
        {links.map(link => (
          <li key={link} className="text-sm text-gray-500 hover:text-white cursor-pointer transition-colors">
            {link}
          </li>
        ))}
      </ul>
